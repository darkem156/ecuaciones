...
def replace_D(text):
    ...
    elements = re.split(r"(?<![a-zA-Z]\()([+\-\s=])", text)
        ...
        if sys.argv[1] == "sustituir":
            ...
            if "c1" in str(simplify(result1)):
                ...
                if c_value!= []:
                    ...
                    new_x = expand(x.subs(c1,c_value[0]))
                    new_y = expand(y.subs(c1,c_value[0]))
                    print('x=',new_x)
                    print('y=',new_y)
            ...
            if 'c2' in str(simplify(result1)):
                ...
                if c_value != []:
                    print('Resultado actualizado:')
                    new_x = expand(x.subs(c2,c_value[0]))
                    new_y = expand(y.subs(c2,c_value[0]))
                    print('x=',new_x)
                    print('y=',new_y)
